...
export const skills: Skill[] = [
  ...
  { name: "Tailwind CSS", icon: "tailwindcss", level: 80, category: "frontend" },
  { name: "Framer Motion", icon: "framer-motion", level: 70, category: "frontend" },
  { name: "Laravel", icon: "laravel", level: 70, category: "backend" },
  { name: "PHP", icon: "php", level: 80, category: "backend" },
  ...
  { name: "Xampp", icon: "xampp", level: 80, category: "tools" },
