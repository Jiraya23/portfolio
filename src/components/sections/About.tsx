      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full max-w-md mx-auto aspect-square rounded-3xl overflow-hidden border border-border bg-card/50 backdrop-blur-sm">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full bg-linear-to-br from-accent-500 to-accent-600 flex items-center justify-center mb-6">
                    <span className="text-6xl font-bold text-foreground">M</span>
                  </div>
          ...
          >
            ...
            <div className="mt-8 space-y-4 text-muted-foreground text-lg">
              <p>{t('bio1')}</p>
              <p>{t('bio2')}</p>
            </div>
